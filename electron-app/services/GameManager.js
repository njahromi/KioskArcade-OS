    ...
    async loadLocalManifest() {
        try {
            if (await fs.pathExists(this.manifestPath)) {
                ...
                this.localGames = new Map(manifest.games.map((game) => [game.id, game]));
